...
public class AdapterBaganFinal4 extends RecyclerView.Adapter<AdapterBaganFinal4.BaganFinal4ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull BaganFinal4ViewHolder holder, int position) {
        ...
        Log.d("TAG", "onBindViewHolder: "+ALKeySemuaPemenangB4);
        Log.d("TAG", "onBindViewHolder: "+ALKeyPemenangB4Peserta1);
        Log.d("TAG", "onBindViewHolder: "+ALKeyPemenangB4Peserta2);
        Log.d("TAG", "onBindViewHolder: "+ALNamaPemenangB3Peserta1);
        Log.d("TAG", "onBindViewHolder: "+ALNamaPemenangB3Peserta2);
        Log.d("TAG", "onBindViewHolder: "+ALSkorPemenangB4Peserta1);
        Log.d("TAG", "onBindViewHolder: "+ALSkorPemenangB4Peserta2);
